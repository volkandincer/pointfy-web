            ...
            <div className="rounded-2xl border border-gray-200/70 bg-white/80 p-8 shadow-xl backdrop-blur-md dark:border-gray-800/70 dark:bg-gray-900/80">
              ...
              <div className="space-y-3">
                <button
                  ...
                  onClick={async () => {
                    try {
                      ...
                      const { error } = await supabase.auth.signInWithOAuth({
                        provider: "google",
                        options: {
                          redirectTo: `${window.location.origin}${returnUrl !== "/" ? returnUrl : ""}`,
                        },
                      });
                  ...
                  disabled={loading}
                  className="flex w-full items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-semibold text-gray-700 transition-all hover:bg-gray-50 disabled:opacity-60 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
                >
                ...
                <button
                  ...
                  onClick={async () => {
                    try {
                      ...
                      setMessage(
                        err instanceof Error ? err.message : "GitHub ile giriş başarısız."
                      );
                    }
                  }}
                  disabled={loading}
                ...
                <button
                  ...
                  onClick={async () => {
                    try {
                      ...
                      setMessage(
                        err instanceof Error ? err.message : "Bitbucket ile giriş başarısız."
                      );
                    }
                  }}
                  disabled={loading}
                ...
                >
                  ...
                  Bitbucket ile {isLogin ? "Giriş Yap" : "Kayıt Ol"}
                </button>
              </div>
            </div>
          </div>
