            ...
            <div className="mb-6">
              <div className="mb-6 flex items-center justify-between">
                ...
                <button
                  ...
                  className="inline-flex h-10 items-center justify-center gap-2 rounded-lg border-2 border-blue-600 bg-blue-600 px-4 text-sm font-semibold text-white shadow-sm transition hover:border-blue-700 hover:bg-blue-700"
                >
